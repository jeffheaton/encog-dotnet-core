...
namespace Encog.Fuzzy
{
    ...
    /// To obtain this number, a defuzzification method is performed.</para>
    /// 
    ...
    /// (see <see cref="FuzzySet"/>) of the rules. Putting all those fuzzy sets together results
    ...
    /// of intervals must be chosen. As the number of intervals grow, the precision of the
    /// numerical output grows. 
    /// </para>
    /// 
