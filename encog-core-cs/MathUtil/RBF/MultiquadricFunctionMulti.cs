...
namespace Encog.MathUtil.RBF
{
    ...
    /// </summary>
    public class MultiquadricFunctionMulti : IRadialBasisFunctionMulti
    {
        /// <summary>
        ...
        public MultiquadricFunctionMulti(double peak, double[] center,
                 double[] width)
        {
            this.center = center;
            this.peak = peak;
        ...
        /// <summary>
        /// Construct a Multiquadric function with the specified number of dimensions.
        ...
        public MultiquadricFunctionMulti(int dimensions, double peak,
