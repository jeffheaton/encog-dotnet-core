...
namespace Encog.Persist.Persistors
{
    ...
    /// </summary>
    public class ActivationCompetitivePersistor : IPersistor
    {

        /// <summary>
        /// The winners attribute.
        /// </summary>
        public const String ATTRIBUTE_WINNERS = "winners";
        ...
        public IEncogPersistedObject Load(ReadXML xmlIn)
        {
            ...
            int winners = int.Parse(map
                    [ActivationCompetitivePersistor.ATTRIBUTE_WINNERS]);
        ...
        {
            ActivationCompetitive c = (ActivationCompetitive)obj;
            xmlOut.BeginTag(this.GetType().Name);
            xmlOut.AddProperty(ActivationCompetitivePersistor.ATTRIBUTE_WINNERS,
                    c.MaxWinners);
            xmlOut.EndTag();
        }
    }
