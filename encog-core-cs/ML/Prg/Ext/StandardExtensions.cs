...
namespace Encog.ML.Prg.Ext
{
    ...
    public class StandardExtensions
    {
        ...
        public static IProgramExtensionTemplate EXTENSION_VAR_SUPPORT = new BasicTemplate(
                BasicTemplate.NO_PREC, "#var():{*}", NodeType.Leaf,
                true, 1, (actual) =>
                {
                    int idx = (int)actual.Data[0].ToIntValue();
        ...
        public static IProgramExtensionTemplate EXTENSION_CONST_SUPPORT = new BasicTemplate(
                BasicTemplate.NO_PREC, "#const():{*}", NodeType.Leaf,
                false, 1, (actual) =>
                {
    ...
    (actual) => EvaluateExpr.pow(actual.GetChildNode(0).Evaluate(), actual.GetChildNode(1).Evaluate()), null, null);
