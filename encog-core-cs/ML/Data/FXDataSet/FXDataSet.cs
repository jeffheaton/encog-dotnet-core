...
namespace Encog.ML.Data.FXDataSet
{
    /// <summary>
    ...
    /// </summary>
    public sealed class FXDataSet : TemporalMLDataSet
    {
        /// <summary>
        ...
        /// <summary>
        /// Find your network name with this variable..(Only useful if you are using multiple networks).
        /// </summary>
        ...
        public FXDataSet(IMarketLoader loader, UInt64 inputWindowSize, UInt64 predictWindowSize)
        ...
        public FXDataSet(IMarketLoader loader, UInt64 inputWindowSize, UInt64 predictWindowSize, TimeUnit unit)
            : base(inputWindowSize, predictWindowSize)
        {
        ...
        /// <param name="predictWindowSize">Size of the predict window.</param>
        /// <param name="unit">The time unit to use.</param>
        public FXDataSet(IMarketLoader loader, UInt64 inputWindowSize, UInt64 predictWindowSize, TimeUnit unit, List<MarketDataType> TypeNeed)
            : base(inputWindowSize, predictWindowSize)
        {

            _loader = loader;
            SequenceGrandularity = unit;
            TypesNeeded = TypeNeed;
        }
        /// <summary>
        ...
        public void Load(DateTime begin, DateTime end)
        {
            ...
            foreach (TemporalDataDescription desc in Descriptions)
            {
                ...
                if (!TypesNeeded.Contains(mdesc.DataType))
