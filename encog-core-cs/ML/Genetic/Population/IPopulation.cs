 ...
 namespace Encog.ML.Genetic.Population {
	...
	public interface IPopulation {
		...
		IList<IGenome> Genomes {
		
		/// <returns>The genomes in the population.</returns>
		  get;
		}
		...
		IInnovationList Innovations {
		
		/// <returns>A list of innovations in this population.</returns>
		  get;
		/// <summary>
		/// Set the innovations collection.
		/// </summary>
		...
		/// <returns>The percent to decrease "old" genom's score by.</returns>
		  get;
		/// <summary>
		/// Set the old age penalty.
		/// </summary>
		...
		/// <returns>The age at which to consider a genome "old".</returns>
		  get;
		/// <summary>
		/// Set the age at which a genome is considered "old".
		/// </summary>
		...
		/// <returns>The max population size.</returns>
		  get;
		/// <summary>
		/// Set the max population size.
		/// </summary>
		...
		/// <returns>The survival rate.</returns>
		  get;
		/// <summary>
		/// Set the survival rate.
		/// </summary>
		...
		/// <returns>The age, below which, a genome is considered "young".</returns>
		  get;
		}
		...
		/// <returns>The bonus given to "young" genomes.</returns>
		  get;
		/// <summary>
		/// Set the youth score bonus.
		/// </summary>
