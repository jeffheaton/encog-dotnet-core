 ...
 namespace Encog.ML.Genetic.Species {
	...
	public interface ISpecies {
		...
		/// <returns>How many generations with no improvement.</returns>
		  get;
		/// <summary>
		/// Set the number of generations with no improvement.
		/// </summary>
		...
		/// <returns>Get the leader for this species. The leader is the genome with
		...
		IList<IGenome> Members {
		
		/// <returns>The numbers of this species.</returns>
		  get;
		}
		...
		/// <returns>The number of genomes this species will try to spawn into the
		...
		/// <returns>The number of spawns this species requires.</returns>
		  get;
		/// <summary>
		/// Set the number of spawns required.
		/// </summary>
