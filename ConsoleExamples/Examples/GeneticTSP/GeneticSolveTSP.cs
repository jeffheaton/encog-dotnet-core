    ...
    public class GeneticSolveTSP : IExample
    {
        ...
        private void initPopulation(GeneticAlgorithm ga)
        {
            ...
            for (int i = 0; i < POPULATION_SIZE; i++)
            {
                ...
                ga.PerformScoreCalculation(genome);
            }
            population.Sort();
        }
        ...
        public void displaySolution()
        {
            ...
            foreach (IGene gene in genetic.Population.GetBest().Chromosomes[0].Genes)
            {
                if (!first)
                    Console.Write(">");
        ...
        public void Execute(IExampleInterface app)
        {
            ...
            while (sameSolutionCount < MAX_SAME_SOLUTION)
            {
                ...
                double thisSolution = genetic.Population.GetBest().Score;
