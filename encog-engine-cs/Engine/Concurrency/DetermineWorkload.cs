 ...
 */
 ...
 namespace Encog.Engine.Concurrency {
	...
	public class DetermineWorkload {
		...
		/// <param name="workloadSize_0"/>Total workload size.</param>
		public DetermineWorkload(int threads, int workloadSize_0) {
	
			this.workloadSize = workloadSize_0;
			if (threads == 0) {
				...
				this.threadCount = Math.Min(threads,workloadSize_0);
			}
		}
