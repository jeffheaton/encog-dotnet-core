...
namespace Encog.Engine.Network.Flat
{
    ...
    public class FlatNetwork : IEngineNeuralNetwork
    {
                ...
                int output, bool tanh)
        {
            ...
            FlatLayer[] layers;
            int act = (tanh) ? ActivationFunctions.ACTIVATION_TANH
        ...
        public void CloneFlatNetwork(FlatNetwork result)
        {
            ...
            result.paras = EngineArray.ArrayCopy(this.paras);
        ...
        protected internal void ComputeLayer(int currentLayer)
        {
            ...
            ActivationFunctions.CalculateActivation(
                    ...
                    this.paras, outputIndex, outputSize,
        ...
        /// <returns>The activation types for each of the layers.</returns>
        ...
        /// <returns>The parameter index for each layer.</returns>
        ...
        /// <returns>The activation parameters.</returns>
        ...
        {
            IList<Int32> map = new List<Int32>();
        ...
        public void Init(FlatLayer[] layers)
        {
            ...
            {
                paramCount += layers[i].Params.Length;
            }
            ...
            this.paras = new double[paramCount];
            ...
            for (int i_0 = layers.Length - 1; i_0 >= 0; i_0--)
            {

                FlatLayer layer = layers[i_0];
                FlatLayer nextLayer = null;

                if (i_0 > 0)
                {
                    nextLayer = layers[i_0 - 1];
                }
                ...
                for (int j = layers.Length - 1; j >= 0; j--)
                {
                    ...
                    {
                        this.contextTargetSize[i_0] = layers[j].ContectCount;
                        this.contextTargetOffset[i_0] = neuronIndex
                                + layers[j].TotalCount
        ...
        public double ConnectionLimit
        {
            ...
            set
            {
                ...
                if (this.connectionLimit > Org.Encog.Engine.EncogEngine.DEFAULT_ZERO_TOLERANCE)
                    this.isLimited = true;
            }
        }
        ...
        /// </summary>
        ///
        /// <returns>-1 if there is no uniform activation function, the number of thatactivation function, otherwise.</returns>
        public int UniformActivation
        {
            /// <summary>
            /// Determine if the hidden and output layers have a uniform activation
            /// function. If they do, then return that activation function. Otherwise
        ...
        public bool AnySlopeNotOne()
        {
            for (int i = 0; i < this.activationType.Length - 1; i++)
            {
                ...
                if (Math.Abs(this.paras[this.paramIndex[i]] - 1.0d) > Org.Encog.Engine.EncogEngine.DEFAULT_ZERO_TOLERANCE)
                {
                    return false;
                }
            }
